...
{
    private List<RevitTranslationUnitGroup> _unitGroups { get; set; } = null;
    ...
    public MultiTaskTranslationHandler(TranslationUtils translationUtils, 
                                            List<RevitTranslationUnitGroup> unitGroups, 
    ...
    /// </returns>
    private int CalculateTotalTranslations(List<RevitTranslationUnitGroup> unitGroups)
    {
    ...
    /// </summary>
    private void CreateTranslationTasks(List<RevitTranslationUnitGroup> unitGroups)
    {
        SetupTokenHandler();
    ...
    private void AddTranslationTask(List<Task> translationTasks, RevitTranslationUnit unit)
    {

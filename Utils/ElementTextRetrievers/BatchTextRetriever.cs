...
/// </summary>
internal class BatchTextRetriever : BaseElementTextRetriever
{
    /// <summary>
    ...
    public BatchTextRetriever(List<Element> elements, bool translateProjectParameters)
    {
        ...
        UnitGroups.Add(new TranslationUnitGroup(RevitUtils.Doc));
    ...
    /// </summary>
    internal HashSet<ElementType> ElementTypes { get; } = [];

    /// <summary>
    /// Families to be processed.
    /// </summary>
    internal HashSet<Family> Families { get; } = [];

    /// <summary>
    /// Tagged elements to be processed.
    /// </summary>
    internal HashSet<Element> TaggedElements { get; } = [];

    /// <summary>
    /// TranslationUnitGroups associated with provided elements.
    /// </summary>
    internal List<TranslationUnitGroup> UnitGroups { get; } = [];
    /// <summary>
    ...
    /// <summary>
    /// Adds TranslationUnits to the TranslationUnitGroup with matching Document.
    /// </summary>
    /// <param name="units"></param>
    private void AddUnitsToGroup(List<TranslationUnit> units)
    {

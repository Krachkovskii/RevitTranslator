...
using RevitTranslator.Ui.Library.Win32;

namespace RevitTranslator.Ui.Library.Appearance;
...
public static class WindowBackgroundManager
{
    ...
    )
    {
        ...
        if (Utilities.IsOSWindows11Insider1OrNewer && backdrop is not WindowBackdropType.None)
        {

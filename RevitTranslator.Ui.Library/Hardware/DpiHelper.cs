...
using RevitTranslator.Ui.Library.Interop;

namespace RevitTranslator.Ui.Library.Hardware;
...
{
    [ThreadStatic] private static Matrix _transformToDevice;
    ...
    */
    ...
    {
        PropertyInfo? dpiXProperty = typeof(SystemParameters).GetProperty(
            "DpiX",
        ...
        PropertyInfo? dpiYProperty = typeof(SystemParameters).GetProperty(
            "Dpi",
            BindingFlags.NonPublic | BindingFlags.Static
        );

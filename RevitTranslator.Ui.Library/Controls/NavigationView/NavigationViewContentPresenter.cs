...
using RevitTranslator.Ui.Library.Abstractions.Controls;
using RevitTranslator.Ui.Library.Animations;
...
public class NavigationViewContentPresenter : Frame
{
    ...
    [SuppressMessage(
        ...
        Justification =
            "The library user might make a class inherit from both FrameworkElement and INavigationAware at the same time."
    )]

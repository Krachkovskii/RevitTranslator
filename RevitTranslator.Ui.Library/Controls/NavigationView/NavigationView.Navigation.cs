...
using RevitTranslator.Ui.Library.Abstractions;
...
public partial class NavigationView
{
    ...
    private void RecreateNavigationStackFromHistory(INavigationViewItem item)
    {
        ...
        */
        ...
        ArrayPool<INavigationViewItem>.Shared.Return(latestHistory!, true);
#endif
...
#if NET6_0_OR_GREATER
        array = ArrayPool<INavigationViewItem>.Shared.Rent(arrayLength);
#else
